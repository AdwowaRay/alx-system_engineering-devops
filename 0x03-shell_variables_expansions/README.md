...
103-water_and_stir adds the two numbers stored in the environment variables WATER and STIR and prints the result. WATER is in base water, STIR in base stir, and the result is in base bestchol
